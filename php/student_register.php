...
if (empty($tenth_per)) 
  ...
  if (count($errors) == 0) 
  {
    ...
    {
      $file1 = addslashes(file_get_contents($_FILES['pdf']['tmp_name']));
    }


    $query = "INSERT INTO student (STUDENT_ID,S_PASSWORD,STUDENT_NAME,GENDER,DOB,EMAIL,ADDRESS,CONTACT_NO,BRANCH,TENTH_PER,TENTH_PASS_YEAR,TWELTH_PER,TWELTH_PASS_YEAR,CGPA,PASSING_YEAR,BACKLOGS,APPLY_FOR,IMAGE, PDF) 
          VALUES('$student_id', '$password', '$student_name','$gender', '$dob', '$st_email', '$address1', '$contact_num', '$branch', '$tenth_per', '$tenth_pass', '$twelfth_per', '$twelfth_pass', '$cgpa', '$pass', '$backlogs','$apply','$file', '$file1')";
...
<body >
  ...
  <form method="post" action="student_register.php" enctype="multipart/form-data">
    ...
    <div class="input-group">
      <label>Upload Image <br> (Max Size 512kb)</label>
      <input type="file" name="image" id="image" required="required"/>
    </div>


    <div class="input-group">
      <label>Upload Report <br> (Max Size 512kb)</label>
